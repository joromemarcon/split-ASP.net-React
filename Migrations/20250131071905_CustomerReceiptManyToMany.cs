...
{
    /// <inheritdoc />
    public partial class CustomerReceiptManyToMany : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerReceipts", x => new { x.UserId, x.ReceiptId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "04dc03c5-a4fb-403e-a48a-60f2adf78405", null, "Admin", "ADMIN" },
                    { "9cdbfff4-8a8d-42e4-a406-f715333770de", null, "User", "USER" }
                });
